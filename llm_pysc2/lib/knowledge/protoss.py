...
#     {'m': 400, 'g': 0, 'b': [], 't': 100, 'l': 5},
#   actions.FUNCTIONS.Build_Pylon_screen.id:
#     {'m': 100, 'g': 0, 'b': [units.Protoss.Nexus], 't': 25, 'l': 2},
#   actions.FUNCTIONS.Build_Assimilator_screen.id:
#     {'m': 75, 'g': 0, 'b': [units.Protoss.Pylon], 't': 30, 'l': 3},
#   actions.FUNCTIONS.Build_Gateway_screen.id:
#     {'m': 150, 'g': 0, 'b': [units.Protoss.Pylon], 't': 65, 'l': 3},
...
DATA_PROTOSS = {
    ...
    units.Protoss.RoboticsFacility: {
        ...
        'name_cn': '机械台',
        # wiki英文 Details
        'description': 'Warps in the warp prism, observer, colossus, immortal and disruptor.',
        'target': [],
        # 自己可以受到什么类型伤害，ground/air，只有神族的巨像等少数单位能够同时受到两种伤害
        'target_self': ['ground'],
        # wiki中文 基本信息/属性
